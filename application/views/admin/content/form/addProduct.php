<?php echo form_open_multipart(base_url("index.php/AdminPanel/addProductdb"));?>
    <form  action = "<?php echo base_url("index.php/AdminPanel/addProductdb")?>" method ="POST">
        <div class="fallback">
            <?php 
            ...
            <?php $this->load->view(component('form','area'),[
                ...
                'value'=>'Lütfen Ürün Özelliklerini buraya giriniz',
                'message'=>''
            ]); ?>
            <?php $this->load->view(component('form','area'),[
            ...
            <?php $this->load->view(component('form','area'),[
                'name'=>'sss',
                'ckeditor'=>'true',
                'label'=>'Ürün Sıkça Sorulan Sorular',
                'value'=>'Lütfen Ürün Özelliklerini buraya giriniz',
                'message'=>''
            ]); ?>
        </div>  
