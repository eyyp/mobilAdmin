...
<div class="form-group row <?php if(isset($situation)){echo 'has-'.$situation;} ?>">
    ...
    <div class="col-sm-10">
        <textarea 
            ...
            class="<?php if(isset($ckeditor)){ echo 'ckeditor';}else{echo 'form-control';}  if(isset($size)){echo 'form-control-'.$size;} if(isset($situation)){echo 'form-control-'.$situation;} ?>" 
            ...
            <?php if(isset($inputProps)){ foreach($inputProps as $prop){echo $prop;}} ?>></textarea>
